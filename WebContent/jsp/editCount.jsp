	  ...
	  <div class="back"> 
	   <div class="regmain"> 
		 ...
		 <div class="regwin">
		  ...
		  <div class="left"><input type="text" name="time"  value='<%=request.getAttribute("time") %>' /></div> 
		  <div class="clear"></div> 
		 </div>
		 <div class="regwin">
		 ...
		 <div class="regwin">
		  ...
		  <div class="left"><input  type="text" name="descript"  value='<%=request.getAttribute("description") %>' /></div>
		  <div class="clear"></div> 
		 </div>
		 <div class="regwin">
		 ...
		 <div class="regwin">
		  ...
		  <div class="left"><input type="text" name ="otherPer"  value='<%=request.getAttribute("otherPersonCode") %>'  /></div>
		  <div class="clear"></div> 
		 </div>
	   </div>
	  </div>
