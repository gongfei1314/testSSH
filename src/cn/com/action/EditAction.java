...
public class EditAction implements ServletResponseAware, ServletRequestAware{
	...
	@Autowired
	public IQueryService iQueryService = null;
	public String flag;
...
//	IQueryService iQueryService = new QueryService();
	JsonBook jsonBook = iQueryService.QueryByIdService(accountNum);
...
//       int accountNum = new Integer(request.getParameter("accountNum"));
       ...
       accountBook = new AccountBook(accountNum,personCode,time,accountType,
       		object,descript,money,address,"image",otherPer);
